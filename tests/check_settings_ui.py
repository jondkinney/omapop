...
def main():
    ...
    fixture = Path(__file__).resolve().with_name("settings-ui.qml")
...
""" % json.dumps(fixture.as_uri()))
        ...
        match = re.search(r"OMAPOP_SETTINGS_TESTS (\{[^\n]+\})", result.stdout)
        ...
        return 0 if result.returncode == 0 and summary.get("failed") == 0 and summary.get("passed", 0) >= 20 and captured else 1
